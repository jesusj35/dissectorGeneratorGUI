...
class dissector_builder_area(Frame):
    def __init__(self,master):
        ...
        self.builder_frame = Frame(self, bg='white')
        ...
        canvas = Canvas(self.builder_frame, bd=0, highlightthickness=0,yscrollcommand=vscrollbar.set, bg='white')
        ...
        start = PhotoImage(file="resources/start.gif") 
        ...
        fieldOne = PhotoImage(file="resources/field1.gif")
        ...
        fieldTwo = PhotoImage(file="resources/field2.gif")
        ...
        fieldFour = PhotoImage(file="resources/field4.gif")
        ...
        fieldSixteen = PhotoImage(file="resources/field16.gif")
        ...
        fieldVar = PhotoImage(file="resources/fieldVar.gif")
        ...
        packet = PhotoImage(file="resources/packet.gif")
        ...
        reference = PhotoImage(file="resources/Reference.gif")
        ...
        end = PhotoImage(file="resources/end.gif")
        ...
        expression = PhotoImage(file="resources/expression.gif") 
        ...
        connector = PhotoImage(file="resources/connector.gif")
        ...
        less = PhotoImage(file="resources/less.gif") 
        ...
        gtr = PhotoImage(file="resources/greater.gif") 
        ...
        lessEqual = PhotoImage(file="resources/greater.gif") 
        ...
        greaterEqual = PhotoImage(file="resources/greaterequal.gif") 
        ...
        equal = PhotoImage(file="resources/equal.gif") 
        ...
        nand = PhotoImage(file="resources/nand.gif") 
        ...
        andop = PhotoImage(file="resources/and.gif") 
        ...
        orop = PhotoImage(file="resources/or.gif") 
        ...
        notop = PhotoImage(file="resources/not.gif") 
        ...
        oper = PhotoImage(file="resources/oper.gif") 
