'''@author Jesus Juarez 
   @description File holding and putting together main functionalitiy of GUI. '''
import Tkinter as tk
import ttk
import tkMessageBox
import createProject as cp
import workspaceLauncher as wl
import projectImport as pi
import projectExport as pe
import dissecScript as ds
import organizeView as ov
import openpcap as op
import projectNav as pn
import outputView as ov
import dissectorBuilderArea as dba
...
class maingui(tk.Frame):
    ...
    def __init__(self,master):
        ...
        center = tk.Frame(self, width=450, height=45, padx=3, pady=3)
        btm_frame = tk.Frame(self, width=250, height=45, pady=3)
        ...
        ctr_left = tk.Frame(center, width=150, height=190)
        ctr_mid = tk.Frame(center, width=300, height=210, padx=3, pady=3)
        ...
        # Main area componenets 

        self.project_nav = pn.projectNav(ctr_left)
