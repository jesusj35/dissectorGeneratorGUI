'''@author Jesus Juarez 
   @description File holding project navigation logic '''
import Tkinter as tk
import ttk

class projectNav(tk.Frame):
    def __init__(self,master):
        ...
        self.img_1 = tk.PhotoImage(file="resources/open_folder_icon.gif") #change to your file path
        self.img_1 = self.img_1.subsample(10,10)

        self.img_2 = tk.PhotoImage(file="resources/close_folder_icon.gif")
